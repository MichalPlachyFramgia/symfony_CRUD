...
use CrudBundle\Entity\Blog;
use CrudBundle\Form\BlogType;
...
class BlogController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CrudBundle:Blog')->findAll();

        return $this->render('CrudBundle:Blog:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CrudBundle:Blog:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CrudBundle:Blog')->find($id);
        ...
        return $this->render('CrudBundle:Blog:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CrudBundle:Blog:edit.html.twig', array(
            'entity'      => $entity,
